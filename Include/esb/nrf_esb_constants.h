...
/*****************************************************************************/
#define NRF_ESB_HIGH_IRQ_PRIORITY 0        ///< Interrupt priority the Gazell timer and the radio
#define NRF_ESB_LOW_IRQ_PRIORITY 1         ///< Interrupt priority for Gazell callback functions.
 ...
 * PPI configuration 
 */
#define NRF_ESB_PPI_EEP0 (NRF_PPI -> CH0_EEP)      ///< Gazell PPI event endpoint 0
#define NRF_ESB_PPI_TEP0 (NRF_PPI -> CH0_TEP)      ///< Gazell PPI task endpoint 0
#define NRF_ESB_PPI_EEP1 (NRF_PPI -> CH1_EEP)      ///< Gazell PPI event endpoint 1
#define NRF_ESB_PPI_TEP1 (NRF_PPI -> CH1_TEP)      ///< Gazell PPI task endpoint 1
#define NRF_ESB_PPI_EEP2 (NRF_PPI -> CH2_EEP)      ///< Gazell PPI event endpoint 2
#define NRF_ESB_PPI_TEP2 (NRF_PPI -> CH2_TEP)      ///< Gazell PPI task endpoint 2
...
#define GZLL_DEFAULT_ADDRESS_PIPE0 {0xE7, 0xE7, 0xE7, 0xE7, 0xE7}          
#define GZLL_DEFAULT_ADDRESS_PIPE1 {0xC2, 0xC2, 0xC2, 0xC2, 0xC2} // {2, 5, 8, 11, 14}      
...
#define NRF_ESB_DEFAULT_XOSC_CTL NRF_ESB_XOSC_CTL_AUTO 	///< Deafult setting for controlling the XOSC
