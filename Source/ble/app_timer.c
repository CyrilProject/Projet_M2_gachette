...
#define RTC1_IRQ_PRI            NRF_APP_PRIORITY_LOW                        /**< Priority of the RTC1 interrupt (used for checking for timeouts and executing timeout handlers). */
#define SWI0_IRQ_PRI            NRF_APP_PRIORITY_LOW                        /**< Priority of the SWI0 interrupt (used for updating the timer list). */
                        ...
                        app_timer_evt_schedule_func_t evt_schedule_func)
{
    ...
    if (((uint32_t)p_buffer & 0x00000003) != 0)
    {
...
static timer_user_id_t user_id_get(void)
{
    ...
    {
        case NRF_APP_PRIORITY_HIGH:
            ret = APP_HIGH_USER_ID;
            break;
            
        case NRF_APP_PRIORITY_LOW:
            ret = APP_LOW_USER_ID;
            break;
