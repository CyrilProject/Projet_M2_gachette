...
/**@brief Initialize the Health Thermometer Service.
 *
...
/**@brief Health Thermometer Service BLE stack event handler.
 *
...
/**@brief Sends health thermometer measurement if indication has been enabled.
 *
...
/**@brief Checks if indication of Temperature Measurement is currently enabled.
 *
 * @param[in]   p_hts                  Health Thermometer Service structure.
