...
enum {
  ...
  SVC_ANT_CHAN_RX_SRCH_TIMEOUT_SET,
  SVC_ANT_SRCH_CHAN_PRIORITY_SET,
  SVC_ANT_SRCH_SHARING_CYCLES_SET,
  SVC_ANT_SRCH_SHARING_CYCLES_GET,
  SVC_ANT_CHAN_LOW_PRIO_RX_SRCH_TIMEOUT_SET,
 ...
 * @return ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_STACK_INIT) ant_stack_reset (void);
 ...
 */
uint32_t SVCALL(SVC_ANT_EVENT_GET) ant_event_get (uint8_t *pucChannel, uint8_t *pucEvent, uint8_t *aucANTMesg);
 ...
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_ASSIGN) ant_channel_assign (uint8_t ucChannel, uint8_t ucChannelType, uint8_t ucNetwork, uint8_t ucExtAssign);
 ...
 *          ::NRF_ANT_ERROR_CHANNEL_IN_WRONG_STATE
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_UNASSIGN) ant_channel_unassign (uint8_t ucChannel);
 ...
 *          ::NRF_ANT_ERROR_CHANNEL_IN_WRONG_STATE
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_OPEN) ant_channel_open(uint8_t ucChannel);
 ...
 *
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_CLOSE) ant_channel_close (uint8_t ucChannel);
 ...
 */
uint32_t SVCALL(SVC_ANT_RX_SCAN_MODE_START) ant_rx_scan_mode_start (void);
 ...
 */
uint32_t SVCALL(SVC_ANT_TX_BROADCAST_MESSAGE) ant_broadcast_message_tx (uint8_t ucChannel, uint8_t ucSize, uint8_t *aucMesg);
 ...
 *          ::NRF_ANT_ERROR_TRANSFER_IN_ERROR
 */
uint32_t SVCALL(SVC_ANT_TX_ACKNOWLEDGED_MESSAGE) ant_acknowledge_message_tx (uint8_t ucChannel, uint8_t ucSize, uint8_t *aucMesg);
 ...
 *         the input buffer does not change until it is released by the burst handler to avoid data corruption.
 *
 ...
 *          ::NRF_ANT_ERROR_CHANNEL_IN_WRONG_STATE
 */
uint32_t SVCALL(SVC_ANT_BURST_HANDLER_REQUEST) ant_burst_handler_request(uint8_t ucChannel, uint16_t usSize, uint8_t *aucData, uint8_t ucBurstSegment);
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_PENDING_TRANSMIT_CLEAR) ant_pending_transmit_clear (uint8_t ucChannel, uint8_t *pucSuccess);
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_TRANSFER_STOP) ant_transfer_stop (void);
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_NETWORK_KEY_SET) ant_network_address_set (uint8_t ucNetwork, uint8_t *aucNetworkKey);
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_RADIO_FREQ_SET) ant_channel_radio_freq_set (uint8_t ucChannel, uint8_t ucFreq);
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_RADIO_FREQ_GET) ant_channel_radio_freq_get (uint8_t ucChannel, uint8_t *pucRfreq);
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_RADIO_TX_POWER_SET) ant_channel_radio_tx_power_set (uint8_t ucChannel, uint8_t ucTxPower);
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_PROX_SEARCH_SET) ant_prox_search_set (uint8_t ucChannel, uint8_t ucProxThreshold);
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_PERIOD_SET) ant_channel_period_set (uint8_t ucChannel, uint16_t usPeriod);
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_PERIOD_GET) ant_channel_period_get (uint8_t ucChannel, uint16_t *pusPeriod );
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_ID_SET) ant_channel_id_set (uint8_t ucChannel, uint16_t usDeviceNumber, uint8_t ucDeviceType, uint8_t ucTransmitType);
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_ID_GET) ant_channel_id_get (uint8_t ucChannel, uint16_t *pusDeviceNumber, uint8_t *pucDeviceType, uint8_t *pucTransmitType);
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_SEARCH_WAVEFORM_SET) ant_search_waveform_set (uint8_t ucChannel, uint16_t usWaveform);
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_CHAN_RX_SRCH_TIMEOUT_SET) ant_channel_rx_search_timeout_set (uint8_t ucChannel, uint8_t ucTimeout);
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_SRCH_CHAN_PRIORITY_SET) ant_search_channel_priority_set (uint8_t ucChannel, uint8_t ucSearchPriority);

/** @brief This function is used by search sharing to set the number of search cycles of a channel before it will service another channel.
 *
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_SRCH_SHARING_CYCLES_SET) ant_search_sharing_cycles_set (uint8_t ucChannel, uint8_t ucCycles);

/** @brief This function returns the current search sharing cycles.
 *
 * @param[in] ucChannel is an unsigned char (1 octet) denoting the channel number to query.
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_SRCH_SHARING_CYCLES_GET) ant_search_sharing_cycles_get (uint8_t ucChannel, uint8_t *pucCycles);
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_CHAN_LOW_PRIO_RX_SRCH_TIMEOUT_SET) ant_channel_low_priority_rx_search_timeout_set (uint8_t ucChannel, uint8_t ucTimeout);

/** @brief This function sets the advanced burst configuration. Configuration structure is as follows:
 *         Required Byte0 = 0-Disable, 1-Enable
 *         Required Byte1 = RF payload size (1-3 8-byte packet size)
 *         Required Byte2 = Advanced burst required configurations
 *         Required Byte3 = 0, Reserved
 *         Required Byte4 = 0, Reserved
 *         Required Byte5 = Advanced burst optional configuration
 *         Required Byte6 = 0, Reserved
 *         Required Byte7 = 0, Reserved
 *         Optional Byte8 = Advanced burst stalling count config LSB
 *         Optional Byte9 = Advanced burst stalling count config MSB
 *         Optional Byte10 = Advanced burst retry count
 *
 ...
 *          ::NRF_ANT_ERROR_INVALID_PARAMETER_PROVIDED
 */
uint32_t SVCALL(SVC_ANT_ADV_BURST_CONFIG_SET) ant_adv_burst_config_set (uint8_t *aucConfig, uint8_t ucSize);
 ...
 *         Byte0 = RF payload size (1-3 8-byte packet size)
 *         Byte1 = Advanced burst required configurations
 *         Byte2 = 0, Reserved
 *         Byte3 = 0, Reserved
 *         Byte4 = Advanced burst optional configuration
 *         Byte5 = 0, Reserved
 *         Byte6 = 0, Reserved
 *         Byte7 = Advanced burst stalling count config LSB
 *         Byte8 = Advanced burst stalling count config MSB
 *         Byte9 = Advanced burst retry count
 *
 *         Returned structure is as folows for capabilities:
 *         Byte0 = Supported RF payload size
 *         Byte1 = Supported burst configurations
 *         Byte2 = 0, Reserved
 *         Byte3 = 0, Reserved
 *
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_ADV_BURST_CONFIG_GET) ant_adv_burst_config_get (uint8_t ucRequestType, uint8_t *aucConfig);
 ...
 *          ::NRF_ANT_ERROR_INVALID_PARAMETER_PROVIDED
 */
uint32_t SVCALL(SVC_ANT_LIB_CONFIG_SET) ant_lib_config_set (uint8_t ucANTLibConfig);
 ...
 *          ::NRF_ANT_ERROR_INVALID_PARAMETER_PROVIDED
 */
uint32_t SVCALL(SVC_ANT_LIB_CONFIG_CLEAR) ant_lib_config_clear (uint8_t ucANTLibConfig);
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_LIB_CONFIG_GET) ant_lib_config_get (uint8_t *pucANTLibConfig);
 ...
 */
uint32_t SVCALL(SVC_ANT_ID_LIST_ADD) ant_id_list_add (uint8_t ucChannel, uint8_t *aucDevId, uint8_t ucListIndex);
 ...
 *          ::NRF_ANT_ERROR_INVALID_LIST_ID
 */
uint32_t SVCALL(SVC_ANT_ID_LIST_CONFIG) ant_id_list_config (uint8_t ucChannel, uint8_t ucIDListSize, uint8_t ucIncExcFlag);
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_AUTO_FREQ_HOP_TABLE_SET) ant_auto_freq_hop_table_set (uint8_t ucChannel, uint8_t ucFreq0, uint8_t ucFreq1, uint8_t ucFreq2);

/** @brief This function is used to specify filter configuration for channel event message generation. Event codes from 0x01 (EVENT_RX_SEARCH_TIMEOUT) to 0x0A (EVENT_TRANSFER_TX_START) can be
 *         added to the filter by enabling the bit in the configuration corresponding to the value of the error code.
 *         eg.
 *         EVENT_RX_SEARCH_TIMEOUT 0x01 - Bit 1
 *         EVENT_RX_FAIL           0x02 - Bit 2
 *         EVENT_CHANNEL_COLLISION 0x09 - Bit 9
 *
 *         Configuration = (BIT1 | BIT2 | BIT9)
 *
 * @param[in] usFilter is an unsigned short (2 octets) denoting the filter configuration bitfield.
 *
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_EVENT_FILTERING_SET) ant_event_filtering_set (uint16_t usFilter);

/** @brief This function is used to retrieve the filter configuration for channel event message generation.
 *
 * @param[in] pusFilter is the pointer to an unsigned short (2 octets) where the filter configuration will be stored.
 *
 * @return  ::NRF_SUCCESS
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL (SVC_ANT_EVENT_FILTERING_GET) ant_event_filtering_get (uint16_t *pusFilter);
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_ACTIVE) ant_active (uint8_t *pbAntActive );
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_IN_PROGRESS) ant_channel_in_progress (uint8_t *pbChannelInProgress);
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_CHANNEL_STATUS_GET) ant_channel_status_get (uint8_t ucChannel, uint8_t *pucStatus);
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_PENDING_TRANSMIT) ant_pending_transmit (uint8_t ucChannel, uint8_t *pucPending);
 ...
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_INIT_CW_TEST_MODE) ant_cw_test_mode_init (void);

/** @brief This function starts a continuous wave test mode transmission.
 *
 * @param ucRadioFreq is an unsigned char (1 octet) denoting the radio frequency offset from 2400MHz for continuous wave mode. (eg. 2466MHz, ucRadioFreq = 66).
 * @param ucTxPower is an unsigned char (1 octet) denoting the transmit power for continuous wave mode. See Radio TX Power Definitions in ant_parameters.h
 *
 * @return  ::NRF_SUCCESS
 */
uint32_t SVCALL(SVC_ANT_CW_TEST_MODE) ant_cw_test_mode (uint8_t ucRadioFreq, uint8_t ucTxPower);

/** @brief This function gets the version string of the ANT stack.
 *
 * @param aucVersion is the pointer to the buffer where the version string will be copied, the array should be at least 11 octets.
 *
 * @return  ::NRF_SUCCESS
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_VERSION) ant_version_get (uint8_t* aucVersion);

/** @brief This function gets the capabilities of the stack.
 *
 * @param aucCapabilities is the pointer to the buffer where the capabilities message will be copied, the array should be at least 8 octets.
 ...
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_CAPABILITIES) ant_capabilities_get (uint8_t* aucCapabilities);
 ...
 *          ::NRF_ANT_ERROR_TRANSFER_IN_PROGRESS
 */
uint32_t SVCALL(SVC_ANT_BURST_HANDLER_WAIT_FLAG_ENABLE) ant_burst_handler_wait_flag_enable (uint8_t* pucWaitFlag);
 ...
 *          ::NRF_ANT_ERROR_TRANSFER_IN_PROGRESS
 */
 uint32_t SVCALL(SVC_ANT_BURST_HANDLER_WAIT_FLAG_DISABLE) ant_burst_handler_wait_flag_disable (void);
 ...
 *          ::NRF_ANT_ERROR_INVALID_PARAMETER_PROVIDED
 */
uint32_t SVCALL(SVC_ANT_SDU_MASK_SET) ant_sdu_mask_set (uint8_t ucMask, uint8_t *aucMask);

/** @brief This function returns the selective data update (SDU) mask (8 octets) from the specified identifier, ucMask.
 *
 * @param[in] ucMask is an unsigned char (1 octet) denoting the index representing the SDU data mask.
 * @param[in] aucMask is a pointer to the buffer where the SDU data mask will be copied, the array should be at least 8 octects.
 *
 * @return  ::NRF_SUCCESS
 *          ::NRF_ERROR_INVALID_PARAM
 *          ::NRF_ANT_ERROR_INVALID_PARAMETER_PROVIDED
 */
uint32_t SVCALL(SVC_ANT_SDU_MASK_GET) ant_sdu_mask_get (uint8_t ucMask, uint8_t *aucMask);
 ...
 *          ::NRF_ANT_ERROR_INVALID_PARAMETER_PROVIDED
 */
uint32_t SVCALL(SVC_ANT_SDU_MASK_CONFIG) ant_sdu_mask_config (uint8_t ucChannel, uint8_t ucMaskConfig);
 ...
 *            ucEnable is an unsigned char (1 octet) denoting the encryption mode. See Encrypted Channel Defines in ant_parameters.h.
 *            ucKeyNum is an unsigned char (1 octet) denoting the key index of the 128-bit key to be used for encryption. Currently, only key index 0 can be used.
 *
 * @return  ::NRF_SUCCESS
 *          ::NRF_ANT_ERROR_INVALID_PARAMETER_PROVIDED
 *          ::NRF_ANT_ERROR_INVALID_SCAN_TX_CHANNEL
 ...
 *          ::NRF_ANT_ERROR_CHANNEL_IN_WRONG_STATE
 */
uint32_t SVCALL(SVC_ANT_CRYPTO_CHANNEL_ENABLE) ant_crypto_channel_enable (uint8_t ucChannel, uint8_t ucEnable, uint8_t ucKeyNum);
 ...
 *            aucKey is a buffer (16 octets) containing the 128-bit AES key to be assigned to the key index.
 *
 * @return  ::NRF_SUCCESS
 *          ::NRF_ERROR_INVALID_PARAM
 *          ::NRF_ANT_ERROR_INVALID_PARAMETER_PROVIDED
 */
uint32_t SVCALL(SVC_ANT_CRYPTO_KEY_SET) ant_crypto_key_set (uint8_t ucKeyNum, uint8_t *aucKey);
 ...
 *            aucInfo is a buffer containing the information being set (4 octets for ID, 19 octets for custom user data).
 *
 * @return  ::NRF_SUCCESS
 *          ::NRF_ERROR_INVALID_PARAM
 *          ::NRF_ANT_ERROR_INVALID_PARAMETER_PROVIDED
 */
uint32_t SVCALL(SVC_ANT_CRYPTO_INFO_SET) ant_crypto_info_set (uint8_t ucType, uint8_t *aucInfo);
 ...
 *            aucInfo is a pointer to a buffer in which the information retrieved will be copied to (1 octet for supported mode, 4 octets for ID, 19 octets for custom user data).
 *
 * @return  ::NRF_SUCCESS
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_CRYPTO_INFO_GET) ant_crypto_info_get (uint8_t ucType, uint8_t *aucInfo);
 ...
 *            usTimeThreshold is an unsigned short (2 octets) denoting the minimum time threshold before the next radio activity that will trigger generation of the event notification
 *
 * @return  ::NRF_SUCCESS
 *          ::NRF_ANT_ERROR_INVALID_PARAMETER_PROVIDED
 */
uint32_t SVCALL(SVC_ANT_RFACTIVE_NOTIFICATION_CONFIG_SET) ant_rfactive_notification_config_set (uint8_t ucMode, uint16_t usTimeThreshold);
 ...
 *            pusTimeThreshold is a pointer to an unsigned short (2 octets) where the configured time threhold value will be stored.
 *
 * @return  ::NRF_SUCCESS
 *          ::NRF_ERROR_INVALID_PARAM
 */
uint32_t SVCALL(SVC_ANT_RFACTIVE_NOTIFICATION_CONFIG_GET) ant_rfactive_notification_config_get (uint8_t *pucMode, uint16_t *pusTimeThreshold);
