...
enum
{
  SVC_BLE_GAP_ADDRESS_SET  = BLE_GAP_SVC_BASE,  /**< Set own Bluetooth Address. */
  SVC_BLE_GAP_ADDRESS_GET,                      /**< Get own Bluetooth Address. */
  SVC_BLE_GAP_ADV_DATA_SET,                     /**< Set Advertisement Data. */
  SVC_BLE_GAP_ADV_START,                        /**< Start Advertising. */
  SVC_BLE_GAP_ADV_STOP,                         /**< Stop Advertising. */
  SVC_BLE_GAP_SCAN_START,                       /**< Start Scanning. */
  SVC_BLE_GAP_SCAN_STOP,                        /**< Stop Scanning. */
  SVC_BLE_GAP_CONNECT,                          /**< Connect. */
  SVC_BLE_GAP_CONNECT_CANCEL,                   /**< Cancel ongoing connection procedure. */
  SVC_BLE_GAP_CONN_PARAM_UPDATE,                /**< Connection Parameter Update. */
  SVC_BLE_GAP_DISCONNECT,                       /**< Disconnect. */
  SVC_BLE_GAP_TX_POWER_SET,                     /**< Set TX Power. */
  SVC_BLE_GAP_APPEARANCE_SET,                   /**< Set Appearance. */
  SVC_BLE_GAP_APPEARANCE_GET,                   /**< Get Appearance. */
  SVC_BLE_GAP_PPCP_SET,                         /**< Set PPCP. */
  SVC_BLE_GAP_PPCP_GET,                         /**< Get PPCP. */
  SVC_BLE_GAP_DEVICE_NAME_SET,                  /**< Set Device Name. */
  SVC_BLE_GAP_DEVICE_NAME_GET,                  /**< Get Device Name. */
  SVC_BLE_GAP_AUTHENTICATE,                     /**< Initiate Pairing/Bonding. */
  SVC_BLE_GAP_SEC_PARAMS_REPLY,                 /**< Reply with Security Parameters. */
  SVC_BLE_GAP_AUTH_KEY_REPLY,                   /**< Reply with an authentication key. */
  SVC_BLE_GAP_SEC_INFO_REPLY,                   /**< Reply with Security Information. */
  SVC_BLE_GAP_CONN_SEC_GET,                     /**< Obtain connection security level. */
  SVC_BLE_GAP_RSSI_START,                       /**< Start reporting of changes in RSSI */ 
  SVC_BLE_GAP_RSSI_STOP,                        /**< Stop reporting of changes in RSSI */ 
};
...
typedef struct
{
  uint16_t   timeout;                   /**< Timeout for SMP transactions or Security Request in seconds, see @ref ble_gap_authenticate and @ref ble_gap_sec_params_reply for more information */
...
enum
{
  BLE_GAP_EVT_ADV_REPORT  = BLE_GAP_EVT_BASE,   /**< Advertisement report. */
  BLE_GAP_EVT_CONNECTED,                        /**< Connection established. */
...
typedef struct
{
  ...
  uint8_t        scan_rsp;                      /**< If nonzero, ignore type. */
  uint8_t        type;                          /**< See @ref BLE_GAP_ADV_TYPES. */
  uint8_t        dlen;                          /**< Advertisement or scan response data length. */
...
typedef struct
{
  ...
  {
    ble_gap_evt_adv_report_t         device_report;         /**< Advertising Report Event Parameters. */
 ...
 */
SVCALL(SVC_BLE_GAP_ADDRESS_SET, uint32_t, ble_gap_address_set(ble_gap_addr_t const * const p_addr));
 ...
 * @return @ref NRF_ERROR_INVALID_ADDR Invalid pointer supplied.
 */
SVCALL(SVC_BLE_GAP_ADDRESS_GET, uint32_t, ble_gap_address_get(ble_gap_addr_t * const p_addr));


/**@brief Set or update advertisement data fields.
 *
 ...
 * @return @ref NRF_ERROR_BUSY The stack is busy, process pending events and retry.
 */
SVCALL(SVC_BLE_GAP_ADV_DATA_SET, uint32_t, ble_gap_adv_data_set(uint8_t const * const p_data, uint8_t dlen, uint8_t const * const p_sr_data, uint8_t srdlen));
 ...
 */
SVCALL(SVC_BLE_GAP_ADV_START, uint32_t, ble_gap_adv_start(ble_gap_adv_params_t const * const p_adv_params));
 ...
 * @return @ref NRF_ERROR_INVALID_STATE Invalid state to perform operation.
 */
SVCALL(SVC_BLE_GAP_ADV_STOP, uint32_t, ble_gap_adv_stop(void));


/**@brief Start scanning (GAP Discovery procedure, Observer Procedure).
 * @note Not implemented, not valid in peripheral role.
 *
 * @param[in] p_scan_params Pointer to scan parameters structure.
 * @return NRF_ERROR_NOT_SUPPORTED.
 */
SVCALL(SVC_BLE_GAP_SCAN_START, uint32_t, ble_gap_scan_start(ble_gap_scan_params_t const * const p_scan_params));
 ...
 * @return NRF_ERROR_NOT_SUPPORTED
 */
SVCALL(SVC_BLE_GAP_SCAN_STOP, uint32_t, ble_gap_scan_stop(void));


/**@brief Create a connection (GAP Link Establishment).
 * @note Not implemented, not valid in peripheral role.
 *
 * @param[in] p_peer_addr   Pointer to peer address. If this is NULL, then the whitelist will be used to try to connect to one of the devices in it.
 * @param[in] p_conn_params Pointer to desired connection parameters.
 * @return NRF_ERROR_NOT_SUPPORTED
 */
SVCALL(SVC_BLE_GAP_CONNECT, uint32_t, ble_gap_connect(ble_gap_addr_t const * const p_peer_addr, ble_gap_conn_params_t const * const p_conn_params));
 ...
 * @return NRF_ERROR_NOT_SUPPORTED.
 */
SVCALL(SVC_BLE_GAP_CONNECT_CANCEL, uint32_t, ble_gap_connect_cancel(ble_gap_addr_t const * const p_peer_addr));
 ...
 */
SVCALL(SVC_BLE_GAP_CONN_PARAM_UPDATE, uint32_t, ble_gap_conn_param_update(uint16_t conn_handle, ble_gap_conn_params_t const * const p_conn_params));
 ...
 */
SVCALL(SVC_BLE_GAP_DISCONNECT, uint32_t, ble_gap_disconnect(uint16_t conn_handle, uint8_t hci_status_code));
 ...
 * @return @ref NRF_ERROR_BUSY The stack is busy, process pending events and retry.
 */
SVCALL(SVC_BLE_GAP_TX_POWER_SET, uint32_t, ble_gap_tx_power_set(int8_t tx_power));
 ...
 * @return @ref NRF_ERROR_INVALID_PARAM Invalid parameter(s) supplied.
 */
SVCALL(SVC_BLE_GAP_APPEARANCE_SET, uint32_t, ble_gap_appearance_set(uint16_t appearance));
 ...
 * @return @ref NRF_ERROR_INVALID_ADDR Invalid pointer supplied.
 */
SVCALL(SVC_BLE_GAP_APPEARANCE_GET, uint32_t, ble_gap_appearance_get(uint16_t * const p_appearance));
 ...
 * @return @ref NRF_ERROR_INVALID_PARAM Invalid parameter(s) supplied.
 */
SVCALL(SVC_BLE_GAP_PPCP_SET, uint32_t, ble_gap_ppcp_set(ble_gap_conn_params_t const * const p_conn_params));
 ...
 * @return @ref NRF_ERROR_INVALID_ADDR Invalid pointer supplied.
 */
SVCALL(SVC_BLE_GAP_PPCP_GET, uint32_t, ble_gap_ppcp_get(ble_gap_conn_params_t * const p_conn_params));


/**@brief Set GAP device name.
 *
 * @param[in] p_sec_mode Write permissions for the Device Name characteristic see @ref ble_gap_conn_sec_mode_t.
 * @param[in] p_dev_name Pointer to an UTF8 string.
 * @param[in] len   Size of the buffer pointed to by p_dev_name, in octets.
 *
 * @return @ref NRF_SUCCESS Success.
 * @return @ref NRF_ERROR_INVALID_ADDR Invalid pointer supplied.
 * @return @ref NRF_ERROR_INVALID_PARAM Invalid parameter(s) supplied.
 ...
 */
SVCALL(SVC_BLE_GAP_DEVICE_NAME_SET, uint32_t, ble_gap_device_name_set(ble_gap_conn_sec_mode_t const * const p_sec_mode, uint8_t const * const p_dev_name, uint16_t len));


/**@brief Get GAP device name.
 *
 * @param[in]     p_dev_name Pointer to an empty buffer where the UTF8 string will be placed.
 ...
 * @return @ref NRF_ERROR_DATA_SIZE Invalid data size(s) supplied.
 */
SVCALL(SVC_BLE_GAP_DEVICE_NAME_GET, uint32_t, ble_gap_device_name_get(uint8_t * const p_dev_name, uint16_t * const p_len));
 ...
 * @return @ref BLE_ERROR_INVALID_CONN_HANDLE Invalid connection handle supplied.
 */
SVCALL(SVC_BLE_GAP_AUTHENTICATE, uint32_t, ble_gap_authenticate(uint16_t conn_handle, ble_gap_sec_params_t const * const p_sec_params));
 ...
 * @return @ref BLE_ERROR_INVALID_CONN_HANDLE Invalid connection handle supplied.
 */
SVCALL(SVC_BLE_GAP_SEC_PARAMS_REPLY, uint32_t, ble_gap_sec_params_reply(uint16_t conn_handle, uint8_t sec_status, ble_gap_sec_params_t const * const p_sec_params));
 ...
 * @return @ref BLE_ERROR_INVALID_CONN_HANDLE Invalid connection handle supplied.
 */
SVCALL(SVC_BLE_GAP_AUTH_KEY_REPLY, uint32_t, ble_gap_auth_key_reply(uint16_t conn_handle, uint8_t key_type, uint8_t const * const key));
 ...
 * @return @ref NRF_ERROR_BUSY The stack is busy, process pending events and retry.
 */
SVCALL(SVC_BLE_GAP_SEC_INFO_REPLY, uint32_t, ble_gap_sec_info_reply(uint16_t conn_handle, ble_gap_enc_info_t const * const p_enc_info, ble_gap_sign_info_t const * const p_sign_info));
 ...
 * @return @ref BLE_ERROR_INVALID_CONN_HANDLE Invalid connection handle supplied.
 */
SVCALL(SVC_BLE_GAP_CONN_SEC_GET, uint32_t, ble_gap_conn_sec_get(uint16_t conn_handle, ble_gap_conn_sec_t * const p_conn_sec));


/**@brief Start reporting the received singnal strength to the application. 
 *
 * A new event is reported whenever the RSSI value changes, until ble_gap_rrsi_stop() is called.
 *
 * @param[in] conn_handle Connection handle.
 *
 * @return @ref NRF_SUCCESS Success.
 ...
 * @return @ref NRF_ERROR_BUSY The stack is busy, process pending events and retry.
 */
SVCALL(SVC_BLE_GAP_RSSI_START, uint32_t, ble_gap_rssi_start(uint16_t conn_handle));
 ...
 * may be reported after ble_gap_rssi_stop() has been called.
 *
 * @param[in] conn_handle Connection handle.
 *
 * @return @ref NRF_SUCCESS Success.
 ...
 * @return @ref NRF_ERROR_BUSY The stack is busy, process pending events and retry.
 */
SVCALL(SVC_BLE_GAP_RSSI_STOP, uint32_t, ble_gap_rssi_stop(uint16_t conn_handle));
