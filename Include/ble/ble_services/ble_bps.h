...
/**@brief Initialize the Blood Pressure Service.
 *
...
/**@brief Blood Pressure Service BLE stack event handler.
 *
...
/**@brief Sends blood pressure measurement if indication has been enabled.
 *
...
/**@brief Checks if indication of Blood Pressure Measurement is currently enabled.
 *
 * @param[in]   p_bps                  Blood Pressure Service structure.
